    ...
    */
    'fallback_sites' => [
        '1dollar' => [
            'legacy_key' => '1dollar',
            'slug' => '1dollar',
            'name' => 'Digitizing Zone',
            'brand_name' => 'Digitizing Zone',
            ...
            'support_email' => env('SITE_SUPPORT_EMAIL', env('SITE_FROM_EMAIL', env('LEGACY_FROM_EMAIL', env('MAIL_FROM_ADDRESS', 'weborders@digitizingzone.com')))),
            'from_email' => env('SITE_FROM_EMAIL', env('MAIL_FROM_ADDRESS', 'weborders@digitizingzone.com')),
